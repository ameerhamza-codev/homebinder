                    ...
                    if(_formKey.currentState!.validate()){
                      if(file!=null){
                        ...
                        try {
                          ...
                          var response = await dio.post('https://portal.homebinder.io/api/v1/home/new',
                            data: {
                              ...
                              'Lot_number': _lotController.text==''?'N/A':_lotController.text,
                              'sqft': _sqrftController.text==''?'N/A':_sqrftController.text,
                              'land_acres': _acreController.text==''?'N/A':_acreController.text,
                              'build_date': _dateController.text==''?'N/A':_dateController.text,
                              "file":{
                            ...
                            awsRequest(model).then((value){
                              ...
                              showDialog<String>(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  content:  const Text('House added successfully', textAlign: TextAlign.center,),
                                  actions: <Widget>[
                                    TextButton(
                              ...
                              showDialog<String>(
                                context: context,
                                builder: (BuildContext context) => AlertDialog(
                                  content:  const Text('AWS Request Error', textAlign: TextAlign.center,),
                                  actions: <Widget>[
                                    TextButton(
                          ...
                          if (e.response != null) {
                            ...
                            if(e.response!.statusCode==401){
                              showDialog<String>(
                                context: context,
                                builder: (BuildContext context) => AlertDialog(
                                  content:  const Text('User not found', textAlign: TextAlign.center,),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () => Navigator.pop(context, 'OK'),
                                      child: const Text('OK'),
                        ...
                        showDialog<String>(
                          context: context,
                          builder: (BuildContext context) => AlertDialog(
                            content:  const Text('No document selected', textAlign: TextAlign.center,),
                            actions: <Widget>[
                              TextButton(
                                onPressed: () => Navigator.pop(context, 'OK'),
                                child: const Text('OK'),
